        ...
        <div class="row">
            ...
            <div class="col-md-12 mb-3">
                ...
                <input type="text" 
                       name="bearing_number" 
                       id="bearing_number" 
                       class="form-control form-control-sm <?php $__errorArgs = ['bearing_number'];
...
unset($__errorArgs, $__bag); ?>" 
                       value="<?php echo e(old('bearing_number', $pillowBlock->bearing_number ?? '')); ?>" 
                       placeholder="e.g. UCP201">
                <?php $__errorArgs = ['bearing_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mt-3 border-top pt-3">
            ...
            <div id="specs-container">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $existingSpecs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $spec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="row g-2 align-items-end mb-2 spec-row">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="specifications[<?php echo e($index); ?>][title]" class="form-control form-control-sm" value="<?php echo e($spec['title'] ?? ''); ?>" placeholder="e.g. Center Height">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label-sm small fw-semibold text-secondary mb-1">Dimension</label>
                            <input type="text" name="specifications[<?php echo e($index); ?>][dimension]" class="form-control form-control-sm" value="<?php echo e($spec['dimension'] ?? ''); ?>" placeholder="e.g. h">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label-sm small fw-semibold text-secondary mb-1">Value</label>
                            <input type="text" name="specifications[<?php echo e($index); ?>][value]" class="form-control form-control-sm" value="<?php echo e($spec['value'] ?? ''); ?>" placeholder="e.g. 30.2 mm">
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 mb-3">
                ...
                <input type="text" 
                       name="equiv_skf" 
                       id="equiv_skf" 
                       class="form-control form-control-sm <?php $__errorArgs = ['equiv_skf'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                       value="<?php echo e(old('equiv_skf', $pillowBlock->equiv_skf ?? '')); ?>" 
                       placeholder="Model / ref.">
                <?php $__errorArgs = ['equiv_skf'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-3 mb-3">
                ...
                <input type="text" 
                       name="equiv_fag" 
                       id="equiv_fag" 
                       class="form-control form-control-sm <?php $__errorArgs = ['equiv_fag'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                       value="<?php echo e(old('equiv_fag', $pillowBlock->equiv_fag ?? '')); ?>" 
                       placeholder="Model / ref.">
                <?php $__errorArgs = ['equiv_fag'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-3 mb-3">
                ...
                <input type="text" 
                       name="equiv_ntn" 
                       id="equiv_ntn" 
                       class="form-control form-control-sm <?php $__errorArgs = ['equiv_ntn'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                       value="<?php echo e(old('equiv_ntn', $pillowBlock->equiv_ntn ?? '')); ?>" 
                       placeholder="Model / ref.">
                <?php $__errorArgs = ['equiv_ntn'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-3 mb-3">
                ...
                <input type="text" 
                       name="equiv_timken" 
                       id="equiv_timken" 
                       class="form-control form-control-sm <?php $__errorArgs = ['equiv_timken'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                       value="<?php echo e(old('equiv_timken', $pillowBlock->equiv_timken ?? '')); ?>" 
                       placeholder="Model / ref.">
                <?php $__errorArgs = ['equiv_timken'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH F:\laragon\www\edx\resources\views/admin/pillow-block/partials/pillow-block-spec-form.blade.php ENDPATH**/ ?>