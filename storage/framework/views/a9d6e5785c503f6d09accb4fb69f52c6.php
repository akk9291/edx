                   ...
                   class="edx-cat-card block bg-white rounded-xl border border-line p-4 no-underline text-inherit flex flex-col justify-between h-full">
                    <div>
                        ...
                        <div class="h-[180px] w-full bg-stone-50 rounded-lg overflow-hidden flex items-center justify-center p-4 relative transition-colors duration-300">
                            <img src="<?php echo e($imgUrl); ?>" alt="<?php echo e($category->name); ?>" class="max-w-full max-h-full object-contain pointer-events-none" loading="lazy" width="200" height="200">
                        </div>
                        <div class="heading6 text-black font-bold mt-3 leading-snug text-center"><?php echo e($category->name); ?></div>
                        <div class="body2 mt-1 text-secondary text-xs leading-relaxed line-clamp-3 text-center" style="min-height: 3rem;"><?php echo e($desc); ?></div>
                    </div>
                    <div class="mt-4">
...
<?php endif; ?>
<?php /**PATH F:\laragon\www\edx\resources\views/frontend/partials/edx-product-category.blade.php ENDPATH**/ ?>