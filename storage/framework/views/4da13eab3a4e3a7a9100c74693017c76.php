<?php $__env->startSection('title', 'Edit Pillow Block'); ?>
<?php $__env->startSection('page-title', 'Edit Pillow Block'); ?>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Edit Pillow Block: <?php echo e($pillowBlock->name); ?></h5>
            </div>
            <div class="card-body">
                <form id="pillow-edit-form" action="<?php echo e(route('admin.pillow-block.update', $pillowBlock)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   id="name" 
                                   name="name" 
                                   value="<?php echo e(old('name', $pillowBlock->name)); ?>" 
                                   required>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($category->id); ?>" <?php echo e(old('category_id', $pillowBlock->category_id) == $category->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                   id="brand" 
                                   name="brand" 
                                   value="<?php echo e(old('brand', $pillowBlock->brand)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                   id="sku" 
                                   name="sku" 
                                   value="<?php echo e(old('sku', $pillowBlock->sku)); ?>">
                            <?php $__errorArgs = ['sku'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" 
                                  ...
                                  rows="3" 
                                  placeholder="Brief summary (shown in product cards and below price)"><?php echo e(old('short_description', $pillowBlock->short_description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                           id="price"
                                           name="price"
                                           value="<?php echo e(old('price', $pillowBlock->price)); ?>"
                                           placeholder="0.00">
...
unset($__errorArgs, $__bag); ?>"
                                           id="sale_price"
                                           name="sale_price"
                                           value="<?php echo e(old('sale_price', $pillowBlock->sale_price)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                       id="meta_title"
                                       name="meta_title"
                                       value="<?php echo e(old('meta_title', $pillowBlock->meta_title)); ?>"
                                       maxlength="255">
...
unset($__errorArgs, $__bag); ?>"
                                          ...
                                          rows="3"
                                          maxlength="5000"><?php echo e(old('meta_description', $pillowBlock->meta_description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                       id="meta_keywords"
                                       name="meta_keywords"
                                       value="<?php echo e(old('meta_keywords', $pillowBlock->meta_keywords)); ?>"
                                       maxlength="1000">
...
unset($__errorArgs, $__bag); ?> d-none" 
                                  id="description" 
                                  name="description" 
                                  rows="8"><?php echo e(old('description', $pillowBlock->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php echo $__env->make('admin.pillow-block.partials.pillow-block-spec-form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div id="existing-gallery-images" class="mb-2 d-flex flex-wrap gap-2">
                                        <?php $__currentLoopData = $pillowBlock->galleryImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="position-relative d-inline-block gallery-thumb-wrap" data-path="<?php echo e($img->image_path); ?>">
                                                <img src="<?php echo e(storage_asset($img->image_path)); ?>" alt="Gallery Image" style="width: 80px; height: 80px; object-fit: cover; border-radius: 4px; border: 2px solid #e2e8f0;">
                                                <button type="button" class="btn btn-sm btn-danger position-absolute top-0 end-0 rounded-circle gallery-remove-btn" style="width: 24px; height: 24px; padding: 0; font-size: 12px; line-height: 1;" data-path="<?php echo e($img->image_path); ?>" title="Remove">
                                                    <i class="bi bi-x"></i>
                                                </button>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-md-6 mb-3 mb-md-0">
                                    ...
                                    <?php if($pillowBlock->video): ?>
                                        <div class="mb-2 d-block">
                                            <video src="<?php echo e(storage_asset($pillowBlock->video)); ?>" controls id="currentProductVideo" style="max-width: 250px; border-radius: 4px; border: 1px solid #ddd;"></video>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php if($pillowBlock->pdf_catalogue): ?>
                                        <div class="mb-2 d-block">
                                            <a href="<?php echo e(storage_asset($pillowBlock->pdf_catalogue)); ?>" target="_blank" class="btn btn-sm btn-outline-primary d-inline-flex align-items-center" id="currentPdfLink">
                                    ...
                                    <?php endif; ?>
                                    <input type="file"
                                           class="form-control <?php $__errorArgs = ['pdf_catalogue'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="in_stock" name="in_stock" value="1" <?php echo e(old('in_stock', $pillowBlock->in_stock) ? 'checked' : ''); ?>>
                                <label class="form-check-label" for="in_stock">In Stock</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" <?php echo e(old('is_active', $pillowBlock->is_active) ? 'checked' : ''); ?>>
                                <label class="form-check-label" for="is_active">Active</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" value="1" <?php echo e(old('is_featured', $pillowBlock->is_featured) ? 'checked' : ''); ?>>
                                <label class="form-check-label" for="is_featured">Featured</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="is_new_arrival" name="is_new_arrival" value="1" <?php echo e(old('is_new_arrival', $pillowBlock->is_new_arrival) ? 'checked' : ''); ?>>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" name="sort_order" id="sort_order" value="<?php echo e(old('sort_order', $pillowBlock->sort_order)); ?>" min="0">
                        </div>
                    </div>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\laragon\www\edx\resources\views/admin/pillow-block/edit.blade.php ENDPATH**/ ?>