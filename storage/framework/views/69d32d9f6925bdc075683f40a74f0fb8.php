...
<body>
    ...
    <div id="edx-search-modal" class="edx-search-modal-root" style="display: none;" role="dialog" aria-modal="true" aria-labelledby="edx-search-modal-input" aria-hidden="true">
        <div class="edx-search-modal-shell">
            ...
            <div class="edx-search-modal-card">
                <form action="<?php echo e(route('frontend.range')); ?>" method="get" class="edx-search-modal-form m-0" id="edx-search-modal-form" role="search" aria-label="Search catalogue">
                        ...
                        <div class="edx-search-modal-initial p-4 sm:p-5">
                            <div class="mb-4">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <a href="<?php echo e(route('frontend.range', ['category' => 'deep-groove-ball-bearings'])); ?>" class="edx-search-quick-chip">Deep Groove Ball Bearings</a>
                                    <a href="<?php echo e(route('frontend.range', ['category' => 'angular-contact-ball-bearings'])); ?>" class="edx-search-quick-chip">Angular Contact Bearings</a>
                                    <a href="<?php echo e(route('frontend.range', ['category' => 'spherical-roller-bearings'])); ?>" class="edx-search-quick-chip">Spherical Roller Bearings</a>
                                    <a href="<?php echo e(route('frontend.range', ['category' => 'pillow-block-units'])); ?>" class="edx-search-quick-chip">Pillow Blocks</a>
                                </div>
                            </div>
                            <div>
    ...
    <script>
    (function () {
        var suggestionApiUrl = '<?php echo e(route('frontend.search.suggestions')); ?>';
        ...
        function initAutocomplete(form) {
            ...
            function renderResults(data, query) {
                ...
                // Footer / View all
                var searchRangeUrl = '<?php echo e(route('frontend.range')); ?>?search=' + encodeURIComponent(query);
        ...
        (function () {
            ...
            var suggestionApiUrl = '<?php echo e(route('frontend.search.suggestions')); ?>';
            var searchRangeUrl = '<?php echo e(route('frontend.range')); ?>';
            var debounceTimer = null;
            var currentAbortCtrl = null;
            var selectedIndex = -1;
...
<?php /**PATH F:\laragon\www\edx\resources\views/layouts/frontend.blade.php ENDPATH**/ ?>