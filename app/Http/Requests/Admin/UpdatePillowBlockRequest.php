...
class UpdatePillowBlockRequest extends FormRequest
{
    ...
    {
        $pillowBlockId = $this->route('pillow_block');
        if (is_object($pillowBlockId)) {
            $pillowBlockId = $pillowBlockId->id;
        }
        ...
        return [
            ...
            'sku' => [
                ...
                'string',
                'max:255',
                Rule::unique('pillow_blocks', 'sku')->ignore($pillowBlockId),
            ],
