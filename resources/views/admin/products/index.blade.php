...
<div class="row mb-4">
    <div class="col-12">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="{{ route('admin.products.bearing-export', array_merge($exportQuery, ['format' => 'xlsx', 'scope' => 'all'])) }}">Export All (.xlsx)</a></li>
                        <li><a class="dropdown-item" href="{{ route('admin.products.bearing-export', array_merge($exportQuery, ['format' => 'csv', 'scope' => 'all'])) }}">Export All (.csv)</a></li>
                        <li><a class="dropdown-item" href="{{ route('admin.products.bearing-export', array_merge($exportQuery, ['format' => 'xlsx', 'scope' => 'active'])) }}">Export Active Only</a></li>
                        <li><a class="dropdown-item" href="{{ route('admin.products.bearing-export', array_merge($exportQuery, ['format' => 'xlsx', 'scope' => 'inactive'])) }}">Export Inactive Only</a></li>
                        <li><a class="dropdown-item" href="{{ route('admin.products.bearing-export', array_merge($exportQuery, ['format' => 'xlsx', 'scope' => 'featured'])) }}">Export Featured Only</a></li>
        ...
        <form id="bulkDeleteForm" action="{{ route('admin.products.bulkDestroy') }}" method="POST" class="d-none">
            @csrf
            @method('DELETE')
                            ...
                            @forelse($products as $product)
                                ...
                                <tr>
                                    <td style="padding-left: 20px;">
                                        <input type="checkbox" class="form-check-input select-row" data-id="{{ $product->id }}">
                                    </td>
                                    <td>{{ $product->id }}</td>
                                    <td>
                                        <img src="{{ $imageUrl }}" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function exportSelected(format) {
        ...
        const url = '{{ route('admin.products.bearing-export') }}?format=' + format + '&scope=selected&selected_ids=' + ids.join(',');
