        ...
        <div class="menu-container bg-white h-full">
            <div class="container h-full">
                <div class="menu-main h-full overflow-hidden">
                    ...
                    <form action="{{ route('frontend.range') }}" method="get" class="relative mt-2" role="search" aria-label="Search catalogue" data-bearing-search-form>
                        <i class="ph ph-magnifying-glass text-xl absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none" aria-hidden="true"></i>
                        <input type="search" name="search" value="{{ request('search', '') }}" placeholder="Search bearings (e.g. 6200, UCFL)…" class="h-12 rounded-lg border border-line text-sm w-full pl-10 pr-4 edx-autocomplete-input" autocomplete="off" data-bearing-autocomplete="true" />
